...
<head>
    ...
    <?php $headTitle = "<title>Home Page</title>" ?>
    <?php echo $headTitle ?>
</head>
...
<body>
    ...
    <img
        src="https://static.wikia.nocookie.net/dreamworks/images/8/8c/JadePalaceDW.jpg/revision/lates
t?cb=20150530204741" alt="Panda Home">
</body>
